...
data {
    ...
    int<lower=1> N_calibrator_visits;
...
transformed parameters {
    ...
    for (i in 1:N_calibrator_visits)
        Sigma[i] = var_intrinsic + diag_matrix(
            var_sys_estimator + alpha_sq * ivar_spectrum[i] + var_additive[i]);
}
