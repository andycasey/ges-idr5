...
"""
Ship a WG10 recommended SP product.
"""
...
ship.wg_recommended_sp_template(database,
    "fits-templates/recommended-templates/GES_iDR5_WG10_RecommendedTemplate_14072016_PERSETUP_FixedLengthFLAGColumns.fits",
    "outputs/GES_iDR5_WG10_Recommended_PERSETUP.fits",
    10, overwrite=True, match_by_setup=True)
