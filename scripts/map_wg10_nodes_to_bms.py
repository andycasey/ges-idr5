...
for old_node in old_nodes:
    ...
    print(old_node["id"], old_node["name"], old_node["setup"].strip(), new_node_id, new_node_name, N)
...
reference_nodes = {
    "HR10": (reference_node_id, "cname"),
    "HR21": (reference_node_id, "cname"),
    "HR10|HR21": (reference_node_id, "cname"),
}

for setup, (reference_node_id, match_by) in reference_nodes.items():
    ...
    for parameter in ("teff", "logg", "feh"):
        ...
        coeffs = model._get_mapping_coefficients(
            ...
            sql_constraint="(r.teff < 6000 or name not like 'Nice%') and r.snr > 50 and r.teff > 4000 and r.teff < 6500 and "
    ...
    for node_id in node_ids:
        ...
        data.write(
            "node-results/ges-dr5-wg10-MAPPED-MP-{}.fits".format(node_name.replace("|", "-")),
            overwrite=True)
